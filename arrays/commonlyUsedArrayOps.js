...
console.log('Using slice(1), we can cut the first element out of an array          => ', colors.slice(1))
...
console.log('Using slice(1, undefined), we can cut the first element until last    => ', colors.slice(1, undefined))